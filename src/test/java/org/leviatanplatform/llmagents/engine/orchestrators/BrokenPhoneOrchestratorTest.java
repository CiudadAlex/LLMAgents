...
class BrokenPhoneOrchestratorTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        askAndPrintResponse(brokenPhoneOrchestrator,"Our Solar System takes roughly 225–250 million years to complete a single orbit around the center of the Milky Way. " +
